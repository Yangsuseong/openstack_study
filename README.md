...
$ apt-get update
$ apt-get install ansible=2.9.6+dfsg-1 python-pip-whl python3-pip libguestfs-tools

$ pip3 install pip -U
# pip3 와 pip 헷갈리지 않도록 주의. pip3로 update 한 pip를 사용하는것.
$ pip install kolla==10.1.0 kolla-ansible==10.1.0 tox gitpython pbr requests jinja2 oslo_config -U
